...
export const researchProjects: Record<string, ResearchProject> = {
    'basic-scouting': {
        ...
        duration: 7,
        effectDescription: "Scout Posts will yield minerals occasionally (not yet implemented).",
        tier: 1,
    },
    'improved-extraction': {
        ...
        duration: 8,
        prerequisites: [],
        effectDescription: "Increases mineral yield from Mining Operations by 25%.",
        tier: 1,
    },
    'water-reclamation-1': {
        ...
        duration: 9,
        effectDescription: "Increases water production from Water Wells by 20%.",
        tier: 1,
    },
    'embodiment-prelim': {
        ...
        duration: 10,
        effectDescription: "[MAIN PROGRESSION - 3D PUZZLE GAME] Lays groundwork for advanced human-machine interface technologies.",
        tier: 1,
    ...
    'embodiment-phase-1': {
        ...
        effectDescription: "Enables deeper integration with colony systems.",
        tier: 1,
    },
    'embodiment-phase-2': {
        ...
        effectDescription: "Creates foundation for direct operator-machine interfacing.",
        tier: 1,
    },
    'embodiment-phase-3': {
    ...
    'seismic-mapping': {
        ...
        duration: 9,
        prerequisites: [],
        effectDescription: "Increases power output from Geothermal Plants by 30%.",
        tier: 1,
    },
